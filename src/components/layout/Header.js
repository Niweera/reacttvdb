                ...
                <div className="container">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav mr-auto">
                            ...
                            <li className="nav-item">
                                <a style={headingStyle} className="nav-link" rel="noopener noreferrer" target="_blank" href="https://www.niwder.me">Blog</a>
                            </li>
                        </ul>
                            ...
                            {isAuthenticated ? (
                                <li className="nav-item dropdown">
                                    ...
                                    <div className="dropdown-menu" style={{backgroundColor: '#3b3a30', color: 'white'}} aria-labelledby="navbarDropdown">
                                        ...
                                        <a className="dropdown-item " style={{fontSize: '20px', color:'white'}} href="#!" onClick={this.onClickLogout}>Logout</a>
                                    </div>
                                </li>) : (
                                <li className="nav-item">
